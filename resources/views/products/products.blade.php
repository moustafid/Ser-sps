                    ...
                    <div class="d-flex justify-content-between">
                        @can('اضافة منتج')
                            <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                                data-toggle="modal" href="#exampleModal">اضافة بلدية</a>
                        @endcan
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">اسم بلدية</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">اضافة بلدية</h5>
                    ...
                    <form action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">اسم بلدية</label>
