...
@section('title')
    الوضعية المالية الشهرية لطور الثانوي
@stop
@section('css')
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    @can('اضافة فاتورة')
                        <a href="lycsituations/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>
                    @endcan

                    @can('تصدير EXCEL')
                        <a class="modal-effect btn btn-sm btn-primary" href="{{ url('export_lycsituation') }}"
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            ...
                            @php
                                $i = 0;
                            @endphp
                            @foreach ($LycSituations as $situation)
                                @php
                                    $i++
                                @endphp
                                <tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Credit_OSB') }}</td>
                                    <td style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Revenues_OSB') }}</td>
                                    <td style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Expenses_OSB') }}</td>
                                    <td style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Credit_Fin_Month_OSB') }}</td>
                                    <td style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Credit_OIEB') }}</td>
                                    <td style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Revenues_OIEB') }}</td>
                                    <td style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Expenses_OIEB') }}</td>
                                    <td class="border-right" style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Credit_Fin_Month_OIEB') }}</td>
                                    <td class="border-right" style="text-align: center;vertical-align: middle; ">{{ SituationLycSumValue('Total') }}</td>
