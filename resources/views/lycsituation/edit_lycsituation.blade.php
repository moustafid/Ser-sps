        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ url('lycsituations/update') }}" method="post" enctype="multipart/form-data"
                          autocomplete="off">
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                                <input type="hidden" name="invoice_id" value="{{ $situations->id }}">
                                <label for="inputName" class="control-label">الرقم المكانو</label>
                                <input type="text" class="form-control" value="{{ $situations->Number_manko }}" id="inputName" name="Number_manko"
                            ...
                            <div class="col">
                                ...
                                <select id="etablissement" name="Etablissement" class="form-control select2">
                                    <option value="{{ $situations->Etablissement }}"> {{ $situations->Etablissement }}</option>
                                </select>
                            </div>
                            <div class="col">
                                <label>رقم ح خ</label>
                                <input class="form-control" name="Number_hk" value="{{ $situations->Number_hk }}"
                                       type="text" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ $situations->Credit_OSB }}" id="Credit_OSB" name="Credit_OSB"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="myTotal()" onchange="myOSB()">
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">ايرادات من  01/01 إلى نهاية الشهر</label>
                                <input type="text" class="form-control form-control-lg" value="{{ $situations->Revenues_OSB }}" onkeyup="myTotal()" id="Revenues_OSB"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ $situations->Expenses_OSB }}" id="Expenses_OSB" name="Expenses_OSB"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="myTotal()" onchange="myOSB()">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ $situations->Credit_Fin_Month_OSB }}"  onkeyup="myTotal()" id="Credit_Fin_Month_OSB" name="Credit_Fin_Month_OSB" readonly>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">رصــيـــــــد( 12/31/2022 )</label>
                                <input type="text" class="form-control" value="{{ $situations->Credit_OIEB }}" id="Credit_OIEB" name="Credit_OIEB"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="myTotal()" onchange="myFunction()">
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">ايرادات من  01/01 إلى نهاية الشهر</label>
                                <input type="text" class="form-control form-control-lg" value="{{ $situations->Revenues_OIEB }}" id="Revenues_OIEB"
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">النفقات من 01/01</label>
                                <input type="text" class="form-control" value="{{ $situations->Expenses_OIEB }}" id="Expenses_OIEB" name="Expenses_OIEB"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  onkeyup="myTotal()" onchange="myFunction()">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">رصــــيـــــــد إلى نهاية الشهر</label>
                                <input type="text" class="form-control"  value="{{ $situations->Credit_Fin_Month_OIEB }}" onkeyup="myTotal()" id="Credit_Fin_Month_OIEB" name="Credit_Fin_Month_OIEB" readonly>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ $situations->Total }}"  onkeyup="myTotal()" id="Total" name="Total"
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary" onblur="myTotal()">حفظ البيانات</button>
                        </div>
