...
@section('title')
    الوضعية المالية الشهرية لطور المتوسط
@stop
@section('css')
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    @can('اضافة فاتورة')
                        <a href="moysituations/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>
                    @endcan

                    @can('تصدير EXCEL')
                        <a class="modal-effect btn btn-sm btn-primary" href="{{ url('export_moysituation') }}"
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="3" style="text-align: center;vertical-align: middle; ">إسم المتوسطة</th>
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                @can('تعديل الفاتورة')
                                                    <a class="dropdown-item"
                                                       href=" {{ url('edit_moysituation') }}/{{ $situation->id }}"><i class="text-danger fas fa-pen-alt"></i>&nbsp;&nbsp;تعديل
                                                        الوضعية</a>
                                                @endcan
                            ...
                            @if($count_situation > 0)
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Credit_OSB') }}</td>
                                        <td style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Revenues_OSB') }}</td>
                                        <td style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Expenses_OSB') }}</td>
                                        <td style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Credit_Fin_Month_OSB') }}</td>
                                        <td style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Credit_OIEB') }}</td>
                                        <td style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Revenues_OIEB') }}</td>
                                        <td style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Expenses_OIEB') }}</td>
                                        <td class="border-right" style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Credit_Fin_Month_OIEB') }}</td>
                                        <td class="border-right" style="text-align: center;vertical-align: middle; ">{{ SituationMoySumValue('Total') }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('moysituations.destroy', 'test') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                </div>
