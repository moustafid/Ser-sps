...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">مصلحة البرمجة و متابعة الميزانية</li>
            <li class="slide">
            ...
            @can('الفواتير')
                <li class="side-item side-item-category">مكتب الميزانية و المصالح الإقتصادية</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">وضعية المالية الشهرية</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                        @can('قائمة الفواتير')

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'situations')) }}">طور الإبتدائي</a></li>

                        @endcan

                        @can('الفواتير المدفوعة')

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'moysituations')) }}">طور المتوسط</a>
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'lycsituations')) }}">طور الثانوي</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('التقارير')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">حوصلة الصندوق الشهرية</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_report')) }}">طور الإبتدائي</a>
                            </li>
                        @endcan

                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers_report')) }}">طور المتوسط</a>
                            </li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers_report')) }}">طور الثانوي</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">التنظيم الجغرافي</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">الدوائر</a></li>
                        @endcan

                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'products')) }}">البلديات</a></li>
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'phases')) }}">الأطوار الثلاث</a></li>
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'etablissements')) }}">المؤسسات</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
