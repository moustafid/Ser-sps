...
Route::resource('moysituations', 'MoySituationController');

Route::resource('lycsituations', 'LycSituationController');
...
Route::get('/phase/{id}', 'InvoicesController@getetablissements');

Route::get('/phase/{id}', 'SituationController@getetablissementspre');

Route::get('/phase/{id}', 'MoySituationController@getetablissementsmoy');
...
Route::get('/edit_situation/{id}', 'SituationController@edit');

Route::get('/edit_moysituation/{id}', 'MoySituationController@edit');
...
Route::get('export_invoices', 'SituationController@export');

Route::get('export_moysituation', 'MoySituationController@export');

Route::get('export_lycsituation', 'LycSituationController@export');
